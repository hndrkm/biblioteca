                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        ...
                        if( isset($_POST['login']) ){
							$sql = "SELECT * FROM alumno WHERE nombre_alumno='" .  $_POST['usuario'] . "' and contrasena_alumno='" .  $_POST['clave'] . "'";
							echo $sql;
							if( $rs = mysqli_query($cnn, $sql)) {				
								...
								if(mysqli_num_rows($rs)){
									$row = mysqli_fetch_array($rs);
							 		...
							 		echo "lo lograste ";
							 		echo "<td style='width=100px;'>",$row['nombre_alumno'], "</td>";
							 		ControlSesion::iniciar_sesion($row['clave_alumno'],$row['nombre_alumno']);
							header('Location: Vistas/alumnoLibros.php');
